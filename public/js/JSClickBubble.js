...
function BalloonInit() {
    ...
    if (!JSON.parse(localStorage.getItem("ShowClickBalloon"))){
    	return ;
    }
	...
	switch (++click_cnt) {
            ...
            case 90:
                ...
                break;
            case 100: // ↓
            	 $elem.innerText = "Invites.funヘ(￣ω￣ヘ)Yes!";
                break;
            case 110: // 101
            	 $elem.innerText = "｡◕‿◕｡";
                break;
            ...
            default:
		// 手动更换下面这行双引号里面的内容 如"😀"
                $elem.innerText = musicSymbolArray[Math.floor(Math.random() * 10) % musicSymbolArray.length];
